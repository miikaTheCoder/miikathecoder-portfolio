document.addEventListener('DOMContentLoaded', function() {
    ...
    function addConsoleLine(text) {
      ...
      line.innerHTML = `<span class="console-prompt">miikaTheCoder@portfolio:</span><span class="console-path">~</span> ${text}`;
      ...
      switch(command) {
        case 'help':
          ...
          case 'rickroll':
            ...
            break;
          case 'whoami':
          addConsoleLine('20-year-old developer, Also interested in coding, privacy, security, cybersecurity, and AI.');
          break;
